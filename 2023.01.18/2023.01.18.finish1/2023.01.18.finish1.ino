...
{
  if(L_Sonar_distance < 200)
  {
    motor_control(1,200,10);
  }
  
  else if(R_Sonar_distance < 200)
  {
    motor_control(1,10,200);
  }
  ...
  else if(F_Sonar_distance < 200 && R_Sonar_distance < 200)
  {
    motor_control(-2,200,200);
  }

  else if(F_Sonar_distance < 200 && L_Sonar_distance < 200)
  {
    motor_control(2,200,200);
  }

  else if(F_Sonar_distance < 200 && L_Sonar_distance < 200 && R_Sonar_distance < 200)
  {
